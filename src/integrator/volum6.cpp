...
class Volum6Integrator : public Integrator {
public:
    explicit Volum6Integrator(const PropertyList &props) {
    ...
    std::string toString() const {
        return "Volum6Integrator[]";
    }
};

NORI_REGISTER_CLASS(Volum6Integrator, "volum6");
NORI_NAMESPACE_END
